...
// singly linkedlist refresher
//
// create a node class to represent individual nodes in the list
// class MyNode{
//   constructor(val) {
//     this.val = val
//     this.next = null
...
//   // methods
//   // insert a node to the list(push)
//   pushNode(val) {
//     // first create a new node with the val
